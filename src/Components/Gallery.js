...
function Gallery() {
    return (
        <div class="gallery-container">
            ...
            <img class="wide-image" src={require("../Assets/_DSC8882.jpg")} alt='Banner with the names of the brdie and groom.'></img>
            ...
            <img class="wide-image" src={require("../Assets/_DSC8915.jpg")} alt='Banner with the names of the brdie and groom.'></img>
